export type SiteSettings = { websiteName?: string; logo?: string; supportEmail?: string; accentColor?: string; affiliateDisclosure?: string; searchPlaceholder?: string; headerCtaLabel?: string; headerCtaUrl?: string; footerDescription?: string; newsletterTitle?: string; newsletterText?: string; copyright?: string };
...
export type FooterData = { description?: string; newsletterText?: string; copyrightText?: string; socialLinks?: NavItem[]; legalLinks?: NavItem[]; columns?: { id: string; title: string; links: NavItem[] }[] };
