  ...
  return <PublicShell><div className="detail-page product-page">
    ...
    <section className="product-detail">
      ...
      <div className="product-summary">
        ...
        <AffiliateOutboundLink className="affiliate-cta" href={product.affiliateUrl} productId={product.id} productName={product.title} storeId={store?.id} storeName={store?.name} placement="product">{product.ctaLabel||"View deal"}{store?.name?` at ${store.name}`:""} <span>↗</span></AffiliateOutboundLink>
